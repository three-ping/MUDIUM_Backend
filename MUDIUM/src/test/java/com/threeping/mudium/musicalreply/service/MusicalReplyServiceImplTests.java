...
class MusicalReplyServiceImplTests {
    ...
    void searchReplies() {
        ...
        // When
        List<MusicalReplyDTO> dtoList = musicalReplyService.findAllReply(commentId);


        // Then
        assertNotNull(dtoList, "조회된 대댓글 list는 null이 아니다.");
        assertTrue(dtoList.get(0).getCommentId() == commentId, "조회된 대댓글의 댓글 Id 일치 확인");
    }
